...
if($aksi=='tambah') {
	echo '<div class="card">
		<div class="card-header bg-info text-white font-weight-bold">Tambah Dosen</div>
		<div class="card-body pb-5">';
		elv_tambahuser($profil_dosen);
	echo '</div></div>';
} else if($aksi=='edit') {
	echo '<div class="card">
		<div class="card-header bg-info text-white font-weight-bold">
			<span class="float-left mt-sm-2">Edit Profil</span> 
			<a class="btn btn-light btn-sm float-right" href="?halaman=dosen&aksi=editakun&id='.$id.'"><i class="fa fa-pencil"></i> Edit Akun</a>
		</div>
		<div class="card-body pb-5">';
		elv_edituser($profil_dosen,$id);
	echo '</div></div>';
} else if($aksi=='editakun') {
	echo '<div class="card">
		<div class="card-header bg-info text-white font-weight-bold">
			<span class="float-left mt-sm-2">Edit Akun</span> 
			<a class="btn btn-light btn-sm float-right" href="?halaman=dosen&aksi=edit&id='.$id.'"><i class="fa fa-pencil"></i> Edit Profil</a>
		</div>
		<div class="card-body pb-5">';
		elv_edit_akun_user($profil_dosen,$id);
	echo '</div></div>';
} else {
	...
	<a class="btn btn-info mb-2" href="?halaman=dosen&aksi=tambah"><i class="fa fa-plus-circle"></i> Tambah Dosen</a>
	...
	<table class="table my-4 table-hover bg-white elv-profil-table">
		...
		<tbody>
		<?php foreach ($get_users as $hasil) {
			...
			<tr class="tr-<?php echo $hasil->ID; ?>">
				...
				<div class="d-flex">
					...
					<a class="edit btn btn-info btn-sm" href="<?php the_permalink(); ?>?halaman=dosen&aksi=edit&id=<?php echo $hasil->ID; ?>"><i class="fa fa-pencil"></i></a>
			...
			<?php elv_lihatuser($profil_dosen,$hasil->ID); ?>
			</td></tr>
		<?php } //endforeach ?>
		</tbody>
	</table>
	...
	$totaluser = $result['avail_roles']['dosen'];
